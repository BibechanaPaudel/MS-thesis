...
## Load the data
```{r}
rep1 <- read.csv("Data/Obj1/At_CMV_1st_RNA3_1ng.csv", header=T)
...
## Load the data
```{r}
rep2 <- read.csv("Data/Obj1/At_CMV_2nd_RNA3_1ng.csv", header=T)
...
## Load the data
```{r}
rep1_CP_1ng <- read.csv("Data/Obj1/At_CMV_1st_CP_1ng.csv", header=T)
...
## Load the data
```{r}
rep2_CP_1ng <-read.csv("Data/Obj1/At_CMV_2nd_CP_1ng.csv", header=T)
