...
## Load the data
```{r}
rep1 <- read.csv("Data/Obj1/Nb_PVY_1st_PVY3_10ng.csv", header=T)
...
## Load the data
```{r}
rep2 <- read.csv("Data/Obj1/Nb_PVY_2nd_PVY3_10ng.csv", header=T)
...
## Load the data
```{r}
rep1_PVY3_1ng <- read.csv("Data/Obj1/Nb_PVY_1st_PVY3_1ng.csv", header=T)
...
PVY_2 <- PVY_2 +
  labs(x = NULL, y = NULL) +
  theme(axis.title = element_blank())
# Combine figures and add shared axis titles
...
## Load the data
```{r}
rep1_PVY1_10ng <- read.csv("Data/Obj1/Nb_PVY_1st_PVY1_10ng.csv", header=T)
...
## Load the data
```{r}
rep1_PVY1_1ng <- read.csv("Data/Obj1/Nb_PVY_1st_PVY1_1ng.csv", header=T)
...
## Load the data
```{r}
rep2_PVY1_10ng <-read.csv("Data/Obj1/Nb_PVY_2nd_PVY1_10ng.csv", header=T)
